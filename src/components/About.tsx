        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 shadow-lg hover:shadow-cyan-500/20 transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-gray-400 leading-relaxed">
              I'm a dedicated Computer Science student at GM University, passionate about leveraging cloud technologies to build innovative solutions. I thrive on learning new technologies and applying them to real-world problems.
            </p>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 shadow-lg hover:shadow-cyan-500/20 transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-gray-400 leading-relaxed">
              I specialize in developing scalable web applications using modern frameworks and cloud platforms. My focus areas include serverless computing, full-stack development, and creating efficient cloud-native solutions.
            </p>
          </div>
