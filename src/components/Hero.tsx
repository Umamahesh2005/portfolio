    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-16 px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="mb-8 animate-fade-in">
          <div className="w-48 h-48 mx-auto mb-6 rounded-full overflow-hidden shadow-2xl ring-4 ring-cyan-500/30 hover:ring-cyan-400/50 transition-all duration-300">
            <img 
              src="/WhatsApp Image 2025-11-24 at 21.54.31_8b03d6cd.jpg" 
              alt="S Vivek Profile" 
              className="w-full h-full object-cover scale-125 hover:scale-130 transition-transform duration-300"
            />
          </div>
        </div>
